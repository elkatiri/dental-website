...
export default function SignUpPage() {
  ...
  return (
    <>
      <Head>
        <title>Créer un compte - Espace Patient</title>
        <meta name="description" content="Inscrivez-vous pour accéder à votre espace patient." />
      </Head>
          ...
          <div className="bg-white py-10 px-8 sm:px-12 shadow-xl shadow-slate-200/60 rounded-[2.5rem] border border-slate-100">
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
              <p className="text-sm text-slate-500">
                Déjà inscrit ? <Link href="/login" className="text-blue-600 font-bold hover:underline">Se connecter</Link>
              </p>
            </div>
          </div>
        </div>
